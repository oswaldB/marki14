...
function initializeParseAxios() {
    ...
    console.log("parseAxios and flaskAxios instances initialized and available in window.parseAxios and window.flaskAxios");
    console.log(`Environment: ${isLocalhost ? 'Localhost' : 'Domain'}, Flask API URL: ${flaskBaseURL}`);
}
