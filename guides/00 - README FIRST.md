...
### 4. Interdiction de construire des composants Astro
...
### 5. Utilisation exclusive des icônes Font Awesome

**Règle** : Utilisez uniquement les icônes de la bibliothèque Font Awesome. Aucune autre bibliothèque d'icônes n'est autorisée.

**Justification** : Font Awesome offre une collection cohérente et moderne d'icônes. L'utilisation d'une seule bibliothèque simplifie la maintenance et garantit une apparence uniforme.

**Exemple** :
```astro
import { faHouse as Home, faCircleCheck as CheckCircle2, faTriangleExclamation as AlertTriangle } from '@fortawesome/fontawesome-free';

<i class="fas fa-house w-6 h-6 text-blue-500"></i>
<i class="fas fa-circle-check w-6 h-6 text-green-500"></i>
<i class="fas fa-triangle-exclamation w-6 h-6 text-yellow-500"></i>
```

### 6. Interdiction du CSS personnalisé
...
### 8. Journalisation des interactions Alpine.js
