...
process_webhook() {
    ...
    vibe -p "lit le @console error catcher.md et ensuite utilise le sur toutes les pages concernées par les modifications. lit les guides dans guides/ et cree un plan de correcrtion dans specs/fix-fwebconsole-error.md."
    sleep 10
