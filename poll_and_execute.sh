...
process_webhook() {
    ...
    vibe -p "Met à jour ta todo avec task pour faire : --- $action. Et executes la todo ensuite. Si tu as exectué les prérequis, crée un fichier prerequie-timestamp.md"
    sleep 10
    vibe -p "commit"
